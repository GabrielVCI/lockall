            ...
            <div className="lg:col-span-2">
              <SectionReveal>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="inline-flex items-center gap-2 h-12 px-8 text-[14px] font-heading font-semibold text-white bg-lockall-cyan hover:bg-lockall-cyan-dark rounded transition-all duration-200 shadow-[0_2px_12px_rgba(14,165,233,0.25)]"
                  >
                    Enviar Solicitud
                    <Send size={16} />
                  </button>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-[14px] text-lockall-graphite">info@lockall.com</div>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-[14px] text-lockall-graphite">+1 (809) 123-4567</div>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
